#!/usr/bin/env python
"""
Script to remove specific test products and their associated unused categories and brands
"""
...
def remove_specific_test_products():
    print('🗑️ REMOVING SPECIFIC TEST PRODUCTS')
    print('=' * 40)
    
    # Target products to remove
    target_names = ["test product 910", "testproduct2", "testproduct"]
